...
namespace UAMS
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if(SubjectCurd.readFromFile(subjectpath))
            {
                Console.WriteLine("Subject data loaded ");

            }
            if(DegreeCurd.readFile(degreepath))
            {
                Console.WriteLine("Degree data loaded ");

            }
             if(StudentCurd.ReadFile(studentPath))
            {
            ...
            do
            {
                ...
                { 
                    if(DegreeCurd.degrees.Count > 0 )
                    {
                        ...
                        StudentCurd.StoreInFile(studentPath, s);
                    }
                ...
                if(option == 2)
                {
                    ...
                    DegreeCurd.StoreInFile(degreepath, d);
                }
                if(option == 3)
                {
